 ...
 * htmLawedTest.php
 *
 * To test in browser htmLawed PHP library as OOP class for filtering/correcting HTML.
...
<meta name="description" content="htmLawed <?php echo htmLawed::hl_version();?> test page" />
...
<title>htmLawed (<?php echo htmLawed::hl_version();?>) test</title>
...
<h5 style="float: left; display: inline; margin-top: 0; margin-bottom: 5px;"><a href="https://www.bioinformatics.org/phplabware/internal_utilities/htmLawed/index.php" title="htmLawed home">HTM<big><big>L</big></big>AWED</a> <?php echo htmLawed::hl_version();?> <a href="htmLawedTest.php" title="test home">TEST</a></h5>
...
if ($do) {
    ...
    $out = htmLawed::hl($_POST['text'], $cfg, $_POST['spec']);
